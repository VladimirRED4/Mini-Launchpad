...
const ORACLE_PROGRAM_ID = new PublicKey("3QCqmWfxCZsnQcvKK1MPzGYDXGnRzKz4rgYpwjnNZTQh");
const MINTER_PROGRAM_ID = new PublicKey("8TXKBDBJXhcvkZCyAyvV9Jv7AkQfADf3ZzkEFG7XJ5gM");
